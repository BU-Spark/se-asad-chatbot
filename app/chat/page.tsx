  ...
  return (
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      <div className="mx-auto max-w-3xl px-4 py-6">
        ...
        <div ref={scrollerRef} className="h-[65vh] w-full overflow-y-auto rounded-2xl border bg-white p-4 shadow-sm">
          {messages.length === 0 ? (
            <div className="h-full grid place-items-center text-neutral-400">Say hi to get started</div>
          ) : (
            <ul className="space-y-3">
              ...
              {loading && (
                <li className="flex justify-start">
                  <div className="rounded-2xl bg-neutral-100 px-4 py-2 italic text-neutral-500">thinking…</div>
                </li>
              )}
            </ul>
          )}
